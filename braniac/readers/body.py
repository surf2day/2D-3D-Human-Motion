...
#                start = np.random.randint(low, high)
                ...
                if frames._frameIndex + (multiplier * self._sequence_length + 1) >= num_frames:  #check we do not fall off the end, added for sequential sampling
                    frames._frameIndex = 0
                start = frames._frameIndex 
            ...
            frames._frameIndex += (multiplier * self._sequence_length) #added for sequential sampling
            return np.stack(features, axis=0)
